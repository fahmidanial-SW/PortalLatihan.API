...
{
    public class ParticipanAddRequest
    {
        ...
        public void Validate()
        {
            ...
            {
                throw new System.Exception("Ticket ID is required");
            }

            if (TrainingFeeID == Guid.Empty)
            {
                throw new System.Exception("Training Fee ID is required");
            }
